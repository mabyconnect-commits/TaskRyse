// AUTO-GENERATED from deploy/init.sql — the full schema + demo seed as one string.
// Used by the one-time GET /api/v1/setup endpoint to initialise a fresh database.
module.exports = `-- Taskryse — one-shot database setup for Neon / any Postgres.
